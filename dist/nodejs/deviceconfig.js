...
goog.provide('proto.xray.proxy.wireguard.DeviceConfig');
goog.provide('proto.xray.proxy.wireguard.DeviceConfig.DomainStrategy');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.xray.proxy.wireguard.PeerConfig');
