 ...
 * @const
 */
proto.xray.transport.internet.tls.Config.repeatedFields_ = [2,4,13,14];
...
proto.xray.transport.internet.tls.Config.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    preferServerCipherSuites: jspb.Message.getBooleanFieldWithDefault(msg, 10, false),
...
proto.xray.transport.internet.tls.Config.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setPreferServerCipherSuites(value);
      break;
    case 11:
      var value = /** @type {string} */ (reader.readString());
...
proto.xray.transport.internet.tls.Config.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getPreferServerCipherSuites();
  if (f) {
    writer.writeBool(
      10,
      f
...
/**
 * optional bool prefer_server_cipher_suites = 10;
 * @return {boolean}
 */
proto.xray.transport.internet.tls.Config.prototype.getPreferServerCipherSuites = function() {
 ...
 * @return {!proto.xray.transport.internet.tls.Config} returns this
 */
proto.xray.transport.internet.tls.Config.prototype.setPreferServerCipherSuites = function(value) {
