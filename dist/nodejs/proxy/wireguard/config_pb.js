...
proto.xray.proxy.wireguard.DeviceConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    kernelMode: jspb.Message.getBooleanFieldWithDefault(msg, 9, false)
  };
...
/**
 * optional bool kernel_mode = 9;
 * @return {boolean}
 */
proto.xray.proxy.wireguard.DeviceConfig.prototype.getKernelMode = function() {
 ...
 * @return {!proto.xray.proxy.wireguard.DeviceConfig} returns this
 */
proto.xray.proxy.wireguard.DeviceConfig.prototype.setKernelMode = function(value) {
