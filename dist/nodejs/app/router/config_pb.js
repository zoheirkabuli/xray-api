 ...
 * @const
 */
proto.xray.app.router.RoutingRule.repeatedFields_ = [2,3,10,13,6,11,7,8,9];
...
proto.xray.app.router.RoutingRule.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.xray.app.router.GeoIP.toObject, includeInstance),
    portRange: (f = msg.getPortRange()) && common_net_port_pb.PortRange.toObject(includeInstance, f),
    ...
    sourceCidrList: jspb.Message.toObjectList(msg.getSourceCidrList(),
    proto.xray.app.router.CIDR.toObject, includeInstance),
...
proto.xray.app.router.RoutingRule.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      ...
      break;
    case 4:
      var value = new common_net_port_pb.PortRange;
      reader.readMessage(value,common_net_port_pb.PortRange.deserializeBinaryFromReader);
...
proto.xray.app.router.RoutingRule.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      common_net_port_pb.PortRange.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<!proto.xray.app.router.CIDR>}
 */
proto.xray.app.router.RoutingRule.prototype.getCidrList = function() {
  return /** @type{!Array<!proto.xray.app.router.CIDR>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.xray.app.router.CIDR, 3));
};
 ...
 * @return {!proto.xray.app.router.RoutingRule} returns this
*/
proto.xray.app.router.RoutingRule.prototype.setCidrList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};
 ...
 * @return {!proto.xray.app.router.CIDR}
 */
proto.xray.app.router.RoutingRule.prototype.addCidr = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.xray.app.router.CIDR, opt_index);
};
 ...
 * @return {!proto.xray.app.router.RoutingRule} returns this
 */
proto.xray.app.router.RoutingRule.prototype.clearCidrList = function() {
  return this.setCidrList([]);
};
...
/**
 * optional xray.common.net.PortRange port_range = 4;
 * @return {?proto.xray.common.net.PortRange}
 */
proto.xray.app.router.RoutingRule.prototype.getPortRange = function() {
  return /** @type{?proto.xray.common.net.PortRange} */ (
    jspb.Message.getWrapperField(this, common_net_port_pb.PortRange, 4));
};


/**
 * @param {?proto.xray.common.net.PortRange|undefined} value
 * @return {!proto.xray.app.router.RoutingRule} returns this
*/
proto.xray.app.router.RoutingRule.prototype.setPortRange = function(value) {
 ...
 * @return {!proto.xray.app.router.RoutingRule} returns this
 */
proto.xray.app.router.RoutingRule.prototype.clearPortRange = function() {
  return this.setPortRange(undefined);
};
 ...
 * @return {boolean}
 */
proto.xray.app.router.RoutingRule.prototype.hasPortRange = function() {
...
/**
 * optional xray.common.net.NetworkList network_list = 5;
 * @return {?proto.xray.common.net.NetworkList}
 */
proto.xray.app.router.RoutingRule.prototype.getNetworkList = function() {
  return /** @type{?proto.xray.common.net.NetworkList} */ (
    jspb.Message.getWrapperField(this, common_net_network_pb.NetworkList, 5));
};
 ...
 * @return {!proto.xray.app.router.RoutingRule} returns this
*/
proto.xray.app.router.RoutingRule.prototype.setNetworkList = function(value) {
 ...
 * @return {!proto.xray.app.router.RoutingRule} returns this
 */
proto.xray.app.router.RoutingRule.prototype.clearNetworkList = function() {
 ...
 * @return {boolean}
 */
proto.xray.app.router.RoutingRule.prototype.hasNetworkList = function() {
 ...
 * @return {!Array<!proto.xray.app.router.CIDR>}
 */
proto.xray.app.router.RoutingRule.prototype.getSourceCidrList = function() {
  return /** @type{!Array<!proto.xray.app.router.CIDR>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.xray.app.router.CIDR, 6));
};
 ...
 * @return {!proto.xray.app.router.RoutingRule} returns this
*/
proto.xray.app.router.RoutingRule.prototype.setSourceCidrList = function(value) {
 ...
 * @return {!proto.xray.app.router.CIDR}
 */
proto.xray.app.router.RoutingRule.prototype.addSourceCidr = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.xray.app.router.CIDR, opt_index);
};
 ...
 * @return {!proto.xray.app.router.RoutingRule} returns this
 */
proto.xray.app.router.RoutingRule.prototype.clearSourceCidrList = function() {
  return this.setSourceCidrList([]);
};
