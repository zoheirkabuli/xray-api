 ...
 * @const
 */
proto.xray.app.dns.Config.repeatedFields_ = [1,5,4];
...
proto.xray.app.dns.Config.toObject = function(includeInstance, msg) {
  var f, obj = {
    nameserversList: jspb.Message.toObjectList(msg.getNameserversList(),
    common_net_destination_pb.Endpoint.toObject, includeInstance),
    nameServerList: jspb.Message.toObjectList(msg.getNameServerList(),
    proto.xray.app.dns.NameServer.toObject, includeInstance),
    hostsMap: (f = msg.getHostsMap()) ? f.toObject(includeInstance, proto.xray.common.net.IPOrDomain.toObject) : [],
    clientIp: msg.getClientIp_asB64(),
  ...
  while (reader.nextField()) {
    ...
    case 2:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.xray.common.net.IPOrDomain.deserializeBinaryFromReader, "", new proto.xray.common.net.IPOrDomain());
         });
      break;
    case 3:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
...
proto.xray.app.dns.Config.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(2, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.xray.common.net.IPOrDomain.serializeBinaryToWriter);
  }
  f = message.getClientIp_asU8();
  if (f.length > 0) {
    writer.writeBytes(
...
/**
 * repeated xray.common.net.Endpoint NameServers = 1;
 * @return {!Array<!proto.xray.common.net.Endpoint>}
 */
proto.xray.app.dns.Config.prototype.getNameserversList = function() {
  return /** @type{!Array<!proto.xray.common.net.Endpoint>} */ (
    jspb.Message.getRepeatedWrapperField(this, common_net_destination_pb.Endpoint, 1));
};


/**
 * @param {!Array<!proto.xray.common.net.Endpoint>} value
 * @return {!proto.xray.app.dns.Config} returns this
*/
proto.xray.app.dns.Config.prototype.setNameserversList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.xray.common.net.Endpoint=} opt_value
 * @param {number=} opt_index
 * @return {!proto.xray.common.net.Endpoint}
 */
proto.xray.app.dns.Config.prototype.addNameservers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.xray.common.net.Endpoint, opt_index);
};
 ...
 * @return {!proto.xray.app.dns.Config} returns this
 */
proto.xray.app.dns.Config.prototype.clearNameserversList = function() {
...
/**
 * map<string, xray.common.net.IPOrDomain> Hosts = 2;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.xray.common.net.IPOrDomain>}
 */
proto.xray.app.dns.Config.prototype.getHostsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.xray.common.net.IPOrDomain>} */ (
      jspb.Message.getMapField(this, 2, opt_noLazyCreate,
      proto.xray.common.net.IPOrDomain));
};
 ...
 * @return {!proto.xray.app.dns.Config} returns this
 */
proto.xray.app.dns.Config.prototype.clearHostsMap = function() {
