...
export const WireguardConfig: MessageFns<WireguardConfig> = {
  ...
  create<I extends Exact<DeepPartial<WireguardConfig>, I>>(base?: I): WireguardConfig {
    return WireguardConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<WireguardConfig>, I>>(_: I): WireguardConfig {
    const message = createBaseWireguardConfig();
    return message;
  },
};
