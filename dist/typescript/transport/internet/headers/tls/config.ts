...
export const PacketConfig: MessageFns<PacketConfig> = {
  ...
  create<I extends Exact<DeepPartial<PacketConfig>, I>>(base?: I): PacketConfig {
    return PacketConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PacketConfig>, I>>(_: I): PacketConfig {
    const message = createBasePacketConfig();
    return message;
  },
};
