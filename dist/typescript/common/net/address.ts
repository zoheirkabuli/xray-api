...
function createBaseIPOrDomain(): IPOrDomain {
  return { ip: undefined, domain: undefined };
}

export const IPOrDomain: MessageFns<IPOrDomain> = {
  ...
  create<I extends Exact<DeepPartial<IPOrDomain>, I>>(base?: I): IPOrDomain {
    return IPOrDomain.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<IPOrDomain>, I>>(object: I): IPOrDomain {
    const message = createBaseIPOrDomain();
