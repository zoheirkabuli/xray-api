...
function createBaseAddons(): Addons {
  return { Flow: "", Seed: new Uint8Array(0) };
}
...
export const Addons: MessageFns<Addons> = {
  ...
  create<I extends Exact<DeepPartial<Addons>, I>>(base?: I): Addons {
    return Addons.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Addons>, I>>(object: I): Addons {
    const message = createBaseAddons();
